...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'List discounts' }),
    (0, swagger_1.ApiQuery)({ name: 'productId', required: false, type: String }),
    (0, swagger_1.ApiOkResponse)({ description: 'List of discounts' }),
    (0, common_1.Get)(),
...
__decorate([
    ...
    (0, swagger_1.ApiOkResponse)({ description: 'Discount found' }),
    (0, swagger_1.ApiNotFoundResponse)({ description: 'Discount not found' }),
    (0, common_1.Get)(':id'),
    (0, public_decorator_1.Public)(),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Create discount (admin only)' }),
    (0, swagger_1.ApiBody)({ type: create_discount_dto_1.CreateDiscountDto }),
    (0, swagger_1.ApiCreatedResponse)({ description: 'Discount created' }),
...
__decorate([
    (0, swagger_1.ApiCookieAuth)('accessToken'),
    (0, swagger_1.ApiOperation)({ summary: 'Update discount (admin only)' }),
    (0, swagger_1.ApiParam)({ name: 'id', type: String }),
    (0, swagger_1.ApiBody)({ type: update_discount_dto_1.UpdateDiscountDto }),
    (0, swagger_1.ApiOkResponse)({ description: 'Discount updated' }),
    (0, swagger_1.ApiUnauthorizedResponse)({ description: 'Unauthorized' }),
    (0, swagger_1.ApiForbiddenResponse)({ description: 'Forbidden' }),
    (0, swagger_1.ApiNotFoundResponse)({ description: 'Discount not found' }),
    (0, role_decorator_1.MinRole)(role_enum_1.RoleLevel.ADMIN),
...
__decorate([
    (0, swagger_1.ApiCookieAuth)('accessToken'),
    (0, swagger_1.ApiOperation)({ summary: 'Delete discount (admin only)' }),
    (0, swagger_1.ApiParam)({ name: 'id', type: String }),
    (0, swagger_1.ApiOkResponse)({ description: 'Discount deleted' }),
    (0, swagger_1.ApiUnauthorizedResponse)({ description: 'Unauthorized' }),
    (0, swagger_1.ApiForbiddenResponse)({ description: 'Forbidden' }),
    (0, swagger_1.ApiNotFoundResponse)({ description: 'Discount not found' }),
    (0, role_decorator_1.MinRole)(role_enum_1.RoleLevel.ADMIN),
